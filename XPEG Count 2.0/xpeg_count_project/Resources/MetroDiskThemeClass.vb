...
''' Email: king.aldrin31@gmail.comRadio
...
#End Region
    ...
    Sub New()
        SetStyle(ControlStyles.AllPaintingInWmPaint Or ControlStyles.UserPaint Or ControlStyles.SupportsTransparentBackColor Or
                   ControlStyles.ResizeRedraw Or ControlStyles.OptimizedDoubleBuffer, True)
        DoubleBuffered = True
        Cursor = Cursors.Hand
...
Class MDContextMenuStrip : Inherits ContextMenuStrip
    ...
    Private Sub MDContextMenuStrip_ItemClicked(sender As Object, e As ToolStripItemClickedEventArgs) Handles Me.ItemClicked
